...
parser.add_argument('--checkpoints', default='test', type=str,
...
parser.add_argument('--nl-type', default='gsnl', type=str,
...
parser.add_argument('--relu', default=False, type=int,
...
####################################################
    ...
    if args.valid:
        ...
        checkpoint_fold = os.path.join('save_model', args.checkpoints)
        checkpoint_best = os.path.join('save_model', args.checkpoints, 'model_best.pth.tar')
